module.exports = {
  ...
  let emitted = false;
    ...
    if (!oldState.channel && newState.channel) {
        require('../handlers/voiceChannelJoin.js').execute(client, newMember, newState.channel, Voice, VoiceConfig, event);
        emitted = true;
    }
    
    if (oldState.channel && !newState.channel) {
        require('../handlers/voiceChannelLeave.js').execute(client, newMember, oldState.channel, Voice, VoiceConfig, event); 
        emitted = true;
    }
    
    if (oldState.channel && newState.channel && oldState.channel.id !== newState.channel.id) {
        require('../handlers/voiceChannelSwitch.js').execute(client, newMember, oldState.channel, newState.channel, Voice, VoiceConfig, event);
        emitted = true;
    }
    ...
    if (!oldState.streaming && newState.streaming) {
        require('../handlers/voiceStreamingStart.js').execute(client, newMember, newState.channel, Voice, VoiceConfig, event); // Coming soon in future maybe?
        emitted = true;
    }
    
    if (oldState.streaming && !newState.streaming) {
        require('../handlers/voiceStreamingStop.js').execute(client, newMember, newState.channel, Voice, VoiceConfig, event);
        emitted = true;
    }
